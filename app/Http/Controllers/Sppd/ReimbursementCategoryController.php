...
class ReimbursementCategoryController extends Controller
{
    ...
    {
        $apiUrl = rtrim(env('SPPD_API_URL'), '/') . '/reimbursement/category/index';
        ...
        return view('pages.reimbursement.category.index', compact('category'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $apiUrl = rtrim(env('SPPD_API_URL'), '/') . '/reimbursement/category/store';
        $token = Session::get('jwt_token');
        ...
        try {
            ...
            if ($response->successful()) {
                return redirect()->route('reimbursement.category.index')->with('success', 'Data berhasil ditambahkan.');
            } else {
    ...
    public function update(Request $request)
    {
        ...
        $apiUrl = rtrim(env('SPPD_API_URL'), '/') . '/reimbursement/category/update';
        $token = Session::get('jwt_token');
        ...
        try {
            ...
            if ($response->successful()) {
                return redirect()->route('reimbursement.category.index')->with('success', 'Data berhasil diupdate.');
            } else {
    ...
    public function destroy(Request $request)
    {
        ...
        $apiUrl = rtrim(env('SPPD_API_URL'), '/') . '/reimbursement/category/delete';
        $token = Session::get('jwt_token');
        ...
        try {
            ...
            if ($response->successful()) {
                return redirect()->route('reimbursement.category.index')->with('success', 'data berhasil dihapus.');
            } else {
