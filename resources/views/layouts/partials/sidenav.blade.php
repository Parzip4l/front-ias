...
<div class="sidenav-menu">
    ...
    <div data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarSppd">
                    <ul class="sub-menu">
                        ...
                        <li class="side-nav-item">
                             <a href="{{ route ('sppd.listapprove') }}" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                             <a href="{{ route ('sppd.completed') }}" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="{{route('reimbursement.index')}}" class="side-nav-link">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="companySidebar">
                    <ul class="sub-menu">
                        ...
                        <li class="side-nav-item">
                            <a href="{{route('reimbursement.category.index')}}" class="side-nav-link">Reimbursement Kategori</a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{route('companytype.index')}}" class="side-nav-link">Jenis Usaha</a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{route('employee.index')}}" class="side-nav-link">Karyawan</a>
                        </li>
                        <li class="side-nav-item">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarLayouts">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a href="{{ route('users.index')}}" class="side-nav-link">User List</a>
                        </li>
                        <li class="side-nav-item">
