                    ...
                    <div class="h-100" data-simplebar>
                        ...
                        <div class="card-body border-top border-light">
                            <a href="#"
                                ...
                                aria-controls="other">Other <i class="ti ti-chevron-down ms-auto"></i></a>
                        ...
                        <div class="card-body border-top border-light">
                            <a href="#"
                                ...
                                aria-controls="labels">Labels <i class="ti ti-chevron-down ms-auto"></i></a>
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="d-flex align-items-center">
                                <button type="button"
                                    ...
                                    data-bs-placement="top" data-bs-title="<span class='fs-12'>Mark as read</span>">
                                ...
                                <button type="button"
                                    ...
                                    data-bs-toggle="tooltip" data-bs-html="true" data-bs-trigger="hover"
                                    data-bs-placement="top" data-bs-title="<span class='fs-12'>Report spam</span>">
                            ...
                            <table class="table table-hover mail-list mb-0">
                                <tbody>
                                    <tr class="position-relative">
                                        ...
                                        <td>
                                            <a data-bs-toggle="modal" href="#email-details-modal" role="button"
                                    ...
                                    <tr class="position-relative">
                                        ...
                                        <td>
                                            <button class="btn p-0 text-warning fs-16 flex-shrink-0"><i
                                                    class="ti ti-star-filled"></i></button>
                                        </td>
                            ...
                            <div class="card mb-1 shadow-none border border-light">
                                <div class="p-2">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col ps-0">
                                            <a href="javascript:void(0);"
                                                class="text-muted fw-bold">Greeva-admin-design.zip</a>
