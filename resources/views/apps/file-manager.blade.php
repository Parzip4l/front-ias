        ...
        <div class="d-flex">
            <div class="offcanvas-xl offcanvas-start file-manager" tabindex="-1" id="fileManagerSidebar"
                ...
                <div class="d-flex flex-column">
                    <div class="p-3">
                        <div class="d-flex flex-column">
                            <button type="button"
                                class="btn fw-medium btn-danger drop-arrow-none dropdown-toggle w-100 mb-3">
                                Create New <i class="ti ti-plus ms-1"></i>
                            </button>
                            <div class="file-menu">
                                <a href="#" class="list-group-item d-flex align-items-center active"><i
                                        class="ti ti-folder fs-18 align-middle me-2"></i>My Files</a>
                                <a href="#" class="list-group-item d-flex align-items-center"><i
                                        class="ti ti-brand-google-drive fs-18 align-middle me-2"></i>Google Drive</a>
                                <a href="#" class="list-group-item d-flex align-items-center"><i
                                        class="ti ti-share-3 fs-18 align-middle me-2"></i>Share with me</a>
                                <a href="#" class="list-group-item d-flex align-items-center"><i
                                        class="ti ti-clock fs-18 align-middle me-2"></i>Recent</a>
                                <a href="#" class="list-group-item d-flex align-items-center"><i
                                        class="ti ti-star fs-18 align-middle me-2"></i>Starred</a>
                                <a href="#" class="list-group-item d-flex align-items-center"><i
                                        class="ti ti-trash fs-18 align-middle me-2"></i>Deleted Files</a>
                            </div>
                            ...
                            <div class="mt-5 pt-5">
                                <div class="alert alert-secondary p-3 pt-0 text-center mb-0" role="alert">
                                    ...
                                    <div>
                                        <h5 class="alert-heading fw-medium fs-18 mt-2">Get more space for files</h5>
            ...
            <div class="w-100 border-start">
                <div class="p-3 d-flex align-items-center justify-content-between">
                    ...
                    <a href="#" class="link-reset fw-medium text-decoration-underline link-offset-2">View All <i
                ...
                <div class="table-responsive">
                    <table class="table table-centered table-nowrap border-top mb-0">
                        <thead class="bg-light bg-opacity-25">
                            <tr>
                                <th class="ps-3 fs-12 text-uppercase text-muted">Name</th>
                                <th class="fs-12 text-uppercase text-muted">Uploaded By</th>
                                <th class="fs-12 text-uppercase text-muted">Size</th>
                                <th class="fs-12 text-uppercase text-muted">Last Update</th>
                                <th class="fs-12 text-uppercase text-muted">Members</th>
                                <th class="fs-12 text-uppercase text-muted" style="width: 80px;">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <div>
                                            <a href="javascript: void(0);">
                                                <img src="/images/users/avatar-1.jpg" class="rounded-circle avatar-md"
                                                    alt="friend">
                                            </a>
                                        </div>
                                        <div>
                                ...
                                <td>
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="/images/users/avatar-1.jpg" download="" class="dropdown-item"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div>
                                            <a href="javascript: void(0);">
                                                <img src="/images/users/avatar-2.jpg" class="rounded-circle avatar-md"
                                                    alt="friend">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td class="ps-3">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <span class="fw-medium"><a href="javascript: void(0);"
                                                    class="text-reset">Dashboard tech requirements</a></span>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div>
                                            <a href="javascript: void(0);">
                                                <img src="/images/users/avatar-3.jpg" class="rounded-circle avatar-md"
                                                    alt="friend">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div>
                                            <a href="javascript: void(0);">
                                                <img src="/images/users/avatar-4.jpg" class="rounded-circle avatar-md"
                                                    alt="friend">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div>
                                            <a href="javascript: void(0);">
                                                <img src="/images/users/avatar-5.jpg" class="rounded-circle avatar-md"
                                                    alt="friend">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td id="tooltips-container">
                                    <div class="avatar-group flex-nowrap">
                                        <div class="avatar avatar-sm">
                                            <span class="avatar-title bg-success rounded-circle fw-bold">A</span>
                                        </div>
                                        <div class="avatar avatar-sm">
                                            <span class="avatar-title bg-primary rounded-circle fw-bold">T</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-link me-1"></i> Get Sharable Link</a>
                                            <a href="/images/users/avatar-2.jpg" download="" class="dropdown-item"><i
                                                    class="ti ti-download me-1"></i> Download</a>
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-pin me-1"></i> Pin</a>
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                            ...
                            <tr>
                                <td class="ps-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <div
                                            class="flex-shrink-0 avatar-md bg-primary-subtle d-inline-flex align-items-center justify-content-center rounded-2">
                                            <i class="ti ti-file-type-xls fs-22 text-primary"></i>
                                        </div>
                                        <div>
                                            <span class="fw-medium"><a href="javascript: void(0);"
                                ...
                                <td id="tooltips-container">
                                    <div class="avatar-group flex-nowrap">
                                        ...
                                        <div class="avatar avatar-sm">
                                            <span class="avatar-title bg-warning rounded-circle fw-bold">C</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-link me-1"></i> Get Sharable Link</a>
                                            <a href="/images/users/avatar-3.jpg" download="" class="dropdown-item"><i
                                                    class="ti ti-download me-1"></i> Download</a>
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-pin me-1"></i> Pin</a>
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                            ...
                            <tr>
                                <td class="ps-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <div
                                            class="flex-shrink-0 avatar-md bg-warning-subtle d-inline-flex align-items-center justify-content-center rounded-2">
                                            <i class="ti ti-file-type-ppt fs-22 text-warning"></i>
                                        </div>
                                        <div>
                                            <span class="fw-medium"><a href="javascript: void(0);"
                                ...
                                <td id="tooltips-container">
                                    <div class="avatar-group flex-nowrap">
                                        ...
                                        <div class="avatar avatar-sm">
                                            <span class="avatar-title bg-primary rounded-circle fw-bold">M</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-link me-1"></i> Get Sharable Link</a>
                                            <a href="/images/users/avatar-4.jpg" download="" class="dropdown-item"><i
                                                    class="ti ti-download me-1"></i> Download</a>
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-pin me-1"></i> Pin</a>
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                            ...
                            <tr>
                                <td class="ps-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <div
                                            class="flex-shrink-0 avatar-md bg-success-subtle d-inline-flex align-items-center justify-content-center rounded-2">
                                            <i class="ti ti-file-type-txt fs-22 text-success"></i>
                                        </div>
                                        <div>
                                            <span class="fw-medium"><a href="javascript: void(0);"
                                ...
                                <td id="tooltips-container">
                                    <div class="avatar-group flex-nowrap">
                                        <div class="avatar avatar-sm">
                                            <span class="avatar-title bg-warning rounded-circle fw-bold">E</span>
                                        </div>
                                        <div class="avatar avatar-sm">
                                            <span class="avatar-title bg-secondary rounded-circle fw-bold">N</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-link me-1"></i> Get Sharable Link</a>
                                            <a href="/images/users/avatar-5.jpg" download="" class="dropdown-item"><i
                                                    class="ti ti-download me-1"></i> Download</a>
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-pin me-1"></i> Pin</a>
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                            ...
                            <tr>
                                <td class="ps-3">
                                    <div class="d-flex align-items-center gap-2">
                                        <div
                                            ...
                                            <i class="ti ti-file-type-jpg fs-22 text-secondary"></i>
                                        </div>
                                        <div>
                                            <span class="fw-medium"><a href="javascript: void(0);"
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div>
                                            <a href="javascript: void(0);">
                                                <img src="/images/users/avatar-6.jpg" class="rounded-circle avatar-md"
                                                    alt="friend">
                                            </a>
                                        </div>
                                        <div>
                                ...
                                <td>
                                    <div class="dropdown flex-shrink-0 text-muted">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-link me-1"></i> Get Sharable Link</a>
                                            <a href="/images/users/avatar-6.jpg" download="" class="dropdown-item"><i
                                                    class="ti ti-download me-1"></i> Download</a>
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="ti ti-pin me-1"></i> Pin</a>
                                            <a href="javascript:void(0);" class="dropdown-item"><i
