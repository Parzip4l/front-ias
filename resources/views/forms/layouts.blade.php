@extends('layouts.vertical', ['title' => ''])

@section('content')
    @include('layouts.partials.page-title', ['subtitle' => 'From', 'title' => 'Form Layouts'])
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Here’s a quick example to demonstrate Bootstrap’s form styles. Keep reading for
                        documentation on required classes, form layout, and more.</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Create horizontal forms with the grid by adding the <code>.row</code> class to
                        ...
                        controls. Be sure to add <code>.col-form-label</code> to your <code>&lt;label&gt;</code>s as well so
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">
                        Use the <code>.row-cols-lg-auto</code>, <code>.g-3</code> & <code>.align-items-center</code> class
                        to display a series of labels, form controls, and buttons on a single horizontal row. Form controls
                        within inline forms vary slightly from their default states. Controls only appear inline in
                        viewports that are at least 576px wide to account for narrow viewports on mobile devices.
                    </p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Be sure to use <code>.col-form-label-sm</code> or <code>.col-form-label-lg</code>
                        to your <code>&lt;label&gt;</code>s or <code>&lt;legend&gt;</code>s to correctly follow the size of
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">
                        By adding <code>.row</code> & <code>.g-2</code>, you can have control over the gutter width in as
