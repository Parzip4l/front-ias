...
@section('content')
    @include('layouts.partials.page-title', ['subtitle' => 'From', 'title' => 'Form Inputmask'])
    <div class="card">
                ...
                <div class="col-md-6">
                    <form action="#">
                        <div class="mb-3">
                            ...
                            <p class="mt-1">Add attribute <code>data-toggle="input-mask"
                        ...
                        <div class="mb-3">
                            ...
                            <p class="mt-1">Add attribute <code>data-mask-format="000.000.000.000.000,00"
                                data-reverse="true"</code></p>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Money 2</label>
                            <input type="text" class="form-control" data-toggle="input-mask" data-mask-format="#.##0,00"
                                data-reverse="true">
                            <span class="fs-13 text-muted">e.g "#.##0,00"</span>
                            <p class="mt-1">Add attribute <code>data-toggle="input-mask" data-mask-format="#.##0,00"
                                data-reverse="true"</code></p>
                        </div>
                ...
                <div class="col-md-6">
                    <form action="#">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="mt-1">Add attribute <code>data-mask-format="000.000.000-00"
                                data-reverse="true"</code></p>
                        </div>
                        <div class="mb-3">
...
@section('scripts')
    @vite(['resources/js/components/form-inputmask.js'])
@endsection
