...
@section('content')
    @include('layouts.partials.page-title', ['subtitle' => 'Base UI', 'title' => 'Links'])
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted"><a href="{{ route('second', ['ui', 'utilities']) }}">Colored link helpers</a>
                        have been updated to pair with our link utilities. Use the new utilities to modify the link opacity,
