    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Add captions to your slides easily with the <code>.carousel-caption</code>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Add <code>.carousel-fade</code> to your carousel to animate slides with a fade
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Add <code>data-bs-interval=""</code> to a <code>.carousel-item</code> to change
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Add <code>.carousel-dark</code> to the <code>.carousel</code> for darker
