@extends('layouts.vertical', ['title' => 'Apex Treemap Chart'])

@section('content')
    @include('layouts.partials.page-title', ['subtitle' => 'Apex', 'title' => 'Treemap Charts'])
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="distributed-treemap" class="apex-charts"
                            data-colors="#6b5eae,#31ce77,#fa5c7c,#35b8e0,#39afd1,#ffc35a, #eef2f7, #313a46"></div>
                    </div>
                </div>
                <!-- end card body-->
            </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="color-range-treemap" class="apex-charts" data-colors="#6b5eae,#39afd1"></div>
                    </div>
                </div>
                <!-- end card body-->
            </div>
