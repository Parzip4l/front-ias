@extends('layouts.vertical', ['title' => 'Apex Radar Chart'])
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="basic-radar" class="apex-charts" data-colors="#6b5eae"></div>
                    </div>
                </div>
                <!-- end card body-->
            </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="radar-multiple-series" class="apex-charts" data-colors="#6b5eae,#02a8b5,#fd7e14"></div>
                        <div class="text-center mt-2">
                            <button class="btn btn-sm btn-primary" id="btn-update">Update</button>
                        </div>
                    </div>
                </div>
                <!-- end card body-->
