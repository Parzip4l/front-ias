@extends('layouts.vertical', ['title' => 'Apex Line Chart'])
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="line-chart" class="apex-charts" data-colors="#fbcc5c"></div>
                    </div>
                </div>
                <!-- end card body-->
            </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="line-chart-datalabel" class="apex-charts" data-colors="#35b8e0,#6b5eae"></div>
                    </div>
                </div>
                <!-- end card body-->
            </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="line-chart-syncing2" data-colors="#6b5eae"></div>
                    <div dir="ltr">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="line-chart-missing" class="apex-charts" data-colors="#fbcc5c,#31ce77,#39afd1"></div>
                    </div>
                </div>
                <!-- end card body-->
            </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="line-chart-dashed" class="apex-charts" data-colors="#35b8e0,#31ce77,#39afd1"></div>
                    </div>
                </div>
                <!-- end card body-->
            </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="line-chart-stepline" class="apex-charts" data-colors="#31ce77"></div>
                    </div>
                </div>
                <!-- end card body-->
            </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="chart-line2" class="apex-charts" data-colors="#6b5eae"></div>
...
@section('scripts')
    ...
    @vite(['resources/js/components/chart-apex-line.js'])
@endsection
