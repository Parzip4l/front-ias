...
@section('content')
    @include('layouts.partials.page-title', ['subtitle' => 'Apex', 'title' => 'Area Charts'])
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="basic-area" class="apex-charts" data-colors="#f34943"></div>
                    </div>
                </div>
                <!-- end card body-->
            </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="spline-area" class="apex-charts" data-colors="#6b5eae,#35b8e0"></div>
                    </div>
                </div>
                <!-- end card body-->
            </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="area-chart-negative" class="apex-charts" data-colors="#31ce77,#fbcc5c">
                        </div>
                    </div>
                </div>
                <!-- end card body-->
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="stacked-area" class="apex-charts" data-colors="#6b5eae,#31ce77,#e3eaef">
                        </div>
                    </div>
                </div>
                <!-- end card body-->
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div dir="ltr">
                        <div id="area-timeSeries" class="apex-charts" data-colors="#39afd1,#fa5c7c,#6b5eae">
                        </div>
                    </div>
                </div>
                <!-- end card body-->
