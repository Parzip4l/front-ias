            ...
            <div class="card">
                ...
                <div class="card-body row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="employee_name" value="{{ session('user.name') }}" readonly>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Jabatan</label>
                        <input type="text" class="form-control" name="position" value="{{ session('user.position') }}" readonly>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row" id="addon-list">
                            ...
                            <div class="col-md-3">
                                <div class="card addon-card border" data-id="{{ $addon['id'] }}" data-harga="{{ $addon['harga'] }}">
                                    <div class="card-body text-center">
                                        <h6 class="fw-bold">{{ $addon['nama'] }}</h6>
                                        <small class="text-muted d-block">{{ $addon['desc'] }}</small>
                                        <div class="mt-2 fw-bold text-primary">Rp {{ number_format($addon['harga'], 0, ',', '.') }} / Hari</div>
                                        <input type="checkbox" name="addons[]" value="{{ $addon['id'] }}" class="addon-check mt-2">
                                    </div>
                                </div>
                            </div>
                            @endforeach
