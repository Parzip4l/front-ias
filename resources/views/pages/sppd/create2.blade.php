            ...
            <div class="card">
                ...
                <div class="card-body row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="employee_name" value="{{ session('user.role') }}" readonly>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Jabatan</label>
                        <input type="text" class="form-control" name="position" value="{{ session('user.role') }}" readonly>
                    </div>
