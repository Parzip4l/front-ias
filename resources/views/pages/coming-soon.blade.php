        ...
        <div class="row g-0 justify-content-center w-100 m-xxl-5 px-xxl-4 m-3">
            <div class="col-xl-4 col-lg-5 col-md-6">
                <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                    <a href="{{ route('root') }}" class="auth-brand mb-3">
                            ...
                            <div class="position-relative mb-3">
                                <form class="m-0">
                                    <input type="email" id="email" name="email"
                                        class="form-control rounded border w-100 px-2 py-2" placeholder="Enter Your Email">
                                    <button type="submit"
                                        class="btn btn-primary position-absolute top-50 translate-middle-y translate-middle-x end-0 fw-semibold me-1">Subscribe</button>
                                </form>
                            </div>
                        </div>
                    </div>
