@extends('layouts.vertical', ['title' => 'Tambah Data Perusahaan'])
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="is_pkp" class="form-select @error('is_pkp') is-invalid @enderror" required>
                                    <option value="1" {{ old('is_pkp') == '1' ? 'selected' : '' }}>Ya</option>
                                    <option value="0" {{ old('is_pkp') == '0' ? 'selected' : '' }}>Tidak</option>
                                </select>
                                @error('is_pkp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" name="npwp_number" class="form-control @error('npwp_number') is-invalid @enderror"
                                       value="{{ old('npwp_number') }}" maxlength="25">
                                @error('npwp_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
