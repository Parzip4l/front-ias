@extends('layouts.vertical', ['title' => 'Data Perusahaan'])
                        ...
                        <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                ...
                                <button class="btn btn-sm btn-danger" onclick="confirmDelete({{ $company['id'] }}, '{{ addslashes($company['name']) }}')"><i class="ti ti-trash"></i></button>
                              </td>
                          </tr>
                          @endforeach
                      </tbody>
