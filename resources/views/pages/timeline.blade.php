                        ...
                        <div class="timeline-box">
                            ...
                            <div class="mt-2">
                                <div class="d-flex justify-content-between">
                                    <p class="mb-2 text-dark fw-medium fs-16">Project Completed: Achievements and Outcomes
                                    </p>
                        ...
                        <div class="timeline-box">
                            ...
                            <div class="mt-3">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <h4 class="text-dark mb-0 fw-medium"> New Admin Release In Bootstrap <span
                            ...
                            <div class="mt-3">
                                <div class="d-flex align-items-center  gap-2 my-3">
                                    <img src="/images/users/avatar-5.jpg" alt=""
                                        class="avatar-lg rounded-circle border border-light border-2">
                                    <div>
                                        <h4 class="text-dark fw-medium"> Assigned to serve as the project's director</h4>
                ...
                <div class="timeline-lg-item timeline-item-right">
                    <div class="timeline-desk">
                        <div class="timeline-box">
                            ...
                            <div class="mt-3">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <h4 class="text-dark mb-0  fw-medium"> We have achieved 5.6k sales in our themes.</h4>
