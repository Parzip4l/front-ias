@extends('layouts.vertical', ['title' => 'Budget Kategori List Management'])
                          ...
                          <tr>
                              ...
                              <td>
                                <a href="javascript:void(0)" 
                                    ...
                                    onclick="openEditModal({{ $kategori['id'] }}, '{{ addslashes($kategori['name']) }}')">
                                    Edit
                                </a>
                                <button class="btn btn-sm btn-danger" onclick="confirmDelete({{ $kategori['id'] }}, '{{ addslashes($kategori['name']) }}')">Hapus</button>
                              </td>
                          </tr>
                          @endforeach
                      </tbody>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('budget-category.store')}}" method="post">
                                @csrf
                                <div class="mb-3">
...
@section('scripts')
    ...
    <script>
        function openEditModal(id, name, headId) {
            ...
            form.action = `{{ route('budget-category.update') }}`;
