@extends('layouts.vertical', ['title' => 'Role List Management'])
                          ...
                          <tr>
                              ...
                              <td>
                                <a href="javascript:void(0)" 
                                    ...
                                    onclick="openEditModal({{ $user['id'] }}, '{{ addslashes($user['name']) }}')">Edit</a>
                                <button class="btn btn-sm btn-danger" onclick="confirmDelete({{ $user['id'] }}, '{{ addslashes($user['name']) }}')">Hapus</button>
                              </td>
                          </tr>
                          @endforeach
                      </tbody>
