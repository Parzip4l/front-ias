...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.partials.page-title', ['subtitle' => 'Invoice', 'title' => 'Invoices'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom card-tabs d-flex flex-wrap align-items-center gap-2">
                    ...
                    <div class="d-flex flex-wrap flex-lg-nowrap gap-2">
                        ...
                        <a href="<?php echo e(route('second', ['apps', 'invoice-create'])); ?>" class="btn btn-primary"><i
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Invoices'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Muhamad Sobirin\project\front-ias2\resources\views/apps/invoices.blade.php ENDPATH**/ ?>