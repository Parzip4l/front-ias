    ...
    <div class="row">
        <div class="col-12">
                    ...
                    <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                        ...
                        <tbody>
                          ...
                          <tr>
                              ...
                              <td><?php echo e($company['company_type']['name'] ?? '-'); ?></td>
                              <td>
                                <a href="<?php echo e(route('company.single', $company['id'])); ?>" 
                                ...
                                <button class="btn btn-sm btn-danger" onclick="confirmDelete(<?php echo e($company['id']); ?>, '<?php echo e(addslashes($company['name'])); ?>')"><i class="ti ti-trash"></i></button>
                              </td>
                          </tr>
            ...
            <div class="modal fade" id="modal-import-company" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <form action="<?php echo e(route('company.import')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <a href="<?php echo e(route('company.export-template')); ?>" class="text-primary small">
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Data Perusahaan'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muhamadsobirin/Documents/front-ias/resources/views/pages/company/index.blade.php ENDPATH**/ ?>