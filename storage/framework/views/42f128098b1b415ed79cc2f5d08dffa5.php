...
<div class="sidenav-menu">
    ...
    <div data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarSppd">
                    <ul class="sub-menu">
                        ...
                        <li class="side-nav-item">
                             <a href="<?php echo e(route ('sppd.approved')); ?>" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="<?php echo e(route ('sppd.listpayment')); ?>" class="side-nav-link">
                    <span class="menu-icon"><i class="ti ti-credit-card"></i></span>
                    <span class="menu-text"> Payment SPPD </span>
                </a>
            </li>
            <li class="side-nav-item">
                <a href="<?php echo e(route ('finance.report.index')); ?>" class="side-nav-link">
                    <span class="menu-icon"><i class="ti ti-file-invoice"></i></span>
...
<!-- Sidenav Menu End -->
<?php /**PATH /Users/muhamadsobirin/Documents/front-ias/resources/views/layouts/partials/sidenav.blade.php ENDPATH**/ ?>