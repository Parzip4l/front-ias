            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                        ...
                        <tbody>
                          <?php $__currentLoopData = $divisi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $divisi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        function openEditModal(id, name, headId) {
            ...
            form.action = `<?php echo e(route('divisi.update')); ?>`;
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Divisi List Management'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Muhamad Sobirin\project\front-ias2\resources\views/pages/usermanagement/divisi/index.blade.php ENDPATH**/ ?>