<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.partials.page-title', ['subtitle' => 'Invoices', 'title' => 'View Invoice'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="mb-4">
                                ...
                                <h6 class="fs-14 text-muted mb-2 lh-base">1055 Station Street Fremont, <br /> CA - 94539
                                </h6>
                        ...
                        <div class="col-4">
                            <div class="mb-4">
                                ...
                                <h6 class="fs-14 text-muted mb-2 lh-base">1147 Rohan Drive Suite, <br />Burlington, VT /
                                    82021</h6>
                ...
                <div class="card-body">
                    <div class="bg-body p-2 rounded-2 mt-4">
                        <p class="mb-0"><span class="fs-12 fw-bold text-uppercase">Note : </span>Payment for all accounts
                            is due within 7 days from the date of invoice receipt. Payments can be made via cheque, credit
                            card, or direct online payment. Failure to settle the account within 7 days will result in the
                            agreed quoted fee, as noted above, being charged against the credit details provided as
                            confirmation of the work undertaken.</p>
                    </div>

                    <div class="mt-4">
                        <p class="mb-2 pb-2"><b>Congratulations on your recent purchase!</b> It has been our pleasure to
            ...
            <div class="d-print-none mb-5">
                <div class="d-flex justify-content-center gap-2">
                    <a href="javascript:window.print()" class="btn btn-primary"><i class="ti ti-printer me-1"></i>
                        Print</a>
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Invoice Detail'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Muhamad Sobirin\project\front-ias2\resources\views/apps/invoice-details.blade.php ENDPATH**/ ?>