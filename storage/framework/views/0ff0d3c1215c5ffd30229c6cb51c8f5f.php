...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.partials.page-title', ['subtitle' => 'Invoices', 'title' => 'Create Invoice'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start justify-content-between mb-4">
                            <div class="overflow-hidden position-relative border rounded d-flex align-items-center justify-content-start px-2"
                                ...
                                <img id="preview" src="/images/logo-dark.png" alt="Preview Image" height="28">
                            </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-sm-0 mt-3">
                                <div class="mb-2">
                                    ...
                                    <input type="text" data-provider="flatpickr" data-date-format="d M, Y"
                                        data-deafult-date="today" class="form-control" placeholder="Select Date">
                                </div>
                                <div class="mb-2">
                        ...
                        <div class="mt-4">
                            <div class="table-responsive">
                                <table class="table text-center table-nowrap align-middle mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">01</th>
                                            <td class="text-start">
                                                <input type="text" id="product-detail-one" class="form-control mb-1"
                                        ...
                                        <tr>
                                            <th scope="row">02</th>
                                            <td class="text-start">
                                                <input type="text" id="product-detail-two" class="form-control mb-1"
                                ...
                                <div class="p-2">
                                    <button type="button" class="btn btn-primary"><i class="ti ti-circle-plus me-1"></i>
                                        Add Products</button>
                                </div>
                            </div>
                            <div>
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Create Invoice'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Muhamad Sobirin\project\front-ias2\resources\views/apps/invoice-create.blade.php ENDPATH**/ ?>