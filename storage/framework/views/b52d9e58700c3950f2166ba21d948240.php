...
<?php echo $__env->make('layouts.partials.page-title', ['subtitle' => 'Layout', 'title' => 'Icon View'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-primary-subtle rounded-circle">
                                                <img src="/images/products/logo/logo-1.svg" alt=""
                                                    height="22">
                                            </span>
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-info-subtle rounded-circle">
                                                <img src="/images/products/logo/logo-2.svg" alt=""
                                                    height="22">
                                            </span>
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-secondary-subtle rounded-circle">
                                                <img src="/images/products/logo/logo-3.svg" alt=""
                                                    height="22">
                                            </span>
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-danger-subtle rounded-circle">
                                                <img src="/images/products/logo/logo-4.svg" alt=""
                                                    height="22">
                                            </span>
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-success-subtle rounded-circle">
                                                <img src="/images/products/logo/logo-5.svg" alt=""
                                                    height="22">
                                            </span>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-primary-subtle rounded-circle">
                                                <img src="/images/users/avatar-1.jpg" alt="" height="22"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-info-subtle rounded-circle">
                                                <img src="/images/users/avatar-2.jpg" alt="" height="22"
                                                    class="rounded-circle">
                                            </span>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-secondary-subtle rounded-circle">
                                                <img src="/images/users/avatar-3.jpg" alt="" height="22"
                                                    class="rounded-circle">
                                            </span>
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-warning-subtle rounded-circle">
                                                <img src="/images/users/avatar-4.jpg" alt="" height="22"
                                                    class="rounded-circle">
                                            </span>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-danger-subtle rounded-circle">
                                                <img src="/images/users/avatar-5.jpg" alt="" height="22"
                                                    class="rounded-circle">
                                            </span>
                                        </div>
                                        <div>
                    ...
                    <div class="col-xl-5" dir="ltr">
                        <div class="p-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <p class="mb-1"><img src="/images/flags/us.svg" alt="user-image"
                                        class="me-1 rounded-circle" height="20"> <span class="align-middle">United
                                        States</span> </p>
                                <div>
                            ...
                            <!-- Country Data -->
                            <div class="d-flex justify-content-between align-items-center">
                                <p class="mb-1"><img src="/images/flags/in.svg" alt="user-image"
                            ...
                            <div class="row align-items-center mb-3">
                                <div class="col">
                                    <div class="progress progress-soft progress-sm">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: 28.65%"
                                            aria-valuenow="28.65" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <div class="col-auto">
                            ...
                            <!-- Country Data -->
                            <div class="d-flex justify-content-between align-items-center">
                                <p class="mb-1"><img src="/images/flags/br.svg" alt="user-image"
                                        class="me-1 rounded-circle" height="20"> <span
                            ...
                            <div class="row align-items-center mb-3">
                                <div class="col">
                                    <div class="progress progress-soft progress-sm">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 62.5%"
                                            aria-valuenow="62.5" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <div class="col-auto">
                            ...
                            <!-- Country Data -->
                            <div class="d-flex justify-content-between align-items-center">
                                <p class="mb-1"><img src="/images/flags/ca.svg" alt="user-image"
                                        class="me-1 rounded-circle" height="20"> <span
                            ...
                            <div class="row align-items-center">
                                <div class="col">
                                    <div class="progress progress-soft progress-sm">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: 42.2%"
                                            aria-valuenow="42.2" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <div class="col-auto">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.vertical', ['title' => 'Icon View Layout '], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Muhamad Sobirin\project\front-ias2\resources\views/layout-demo/icon-view.blade.php ENDPATH**/ ?>