    ...
    <?php $__env->startSection('content'); ?>
        <?php echo $__env->make('layouts.partials.page-title', ['title' => 'Finance Report'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div class="row row-cols-xxl-4 row-cols-md-2 row-cols-1 g-3">
            ...
            <div class="col">
                ...
                <div class="card-body">
                    ...
                    <h3 class="mb-0 fw-bold">Rp <?php echo e(number_format($summary['total_pengeluaran'] ?? 0, 0, ',', '.')); ?></h3>
            ...
            <div class="col">
                ...
                <div class="card-body">
                    ...
                    <h3 class="mb-0 fw-bold">Rp <?php echo e(number_format($summary['total_outstanding'] ?? 0, 0, ',', '.')); ?></h3>
            ...
            <div class="col">
                ...
                <div class="card-body">
                    ...
                    <h3 class="mb-0 fw-bold">Rp <?php echo e(number_format($summary['total_digital'] ?? 0, 0, ',', '.')); ?></h3>
            ...
            <div class="col">
                <div class="card overflow-hidden">
                    <div class="card-body">
                        ...
                        <h3 class="mb-0 fw-bold">Rp <?php echo e(number_format($summary['total_reimbursement'] ?? 0, 0, ',', '.')); ?></h3>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="px-3"><?php echo e($loop->iteration); ?></td>
                                        <td><?php echo e($payment['sppd']['nomor_sppd'] ?? '-'); ?></td>
                                        <td><?php echo e($payment['sppd']['user']['name'] ?? '-'); ?></td>
    ...
    <?php $__env->startSection('scripts'); ?>
        ...
        const digital = <?php echo json_encode(array_column($trends, 'digital')); ?>;
        const invoicing = <?php echo json_encode(array_column($trends, 'invoicing')); ?>;
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Finance Report'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muhamadsobirin/Documents/front-ias/resources/views/pages/finance/report/index.blade.php ENDPATH**/ ?>