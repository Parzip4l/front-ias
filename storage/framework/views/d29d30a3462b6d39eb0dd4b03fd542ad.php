...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php endif; ?>
        <form id="form-sppd" method="POST" action="<?php echo e(route('sppd.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="card">
                <div class="card-body">
...
<script src="<?php echo e(asset('js/validatedfile.js')); ?>"></script>
<script>
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Buat SPPD'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muhamadsobirin/Documents/front-ias/resources/views/pages/sppd/create.blade.php ENDPATH**/ ?>