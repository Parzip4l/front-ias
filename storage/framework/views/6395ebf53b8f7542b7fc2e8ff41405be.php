...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e($company['name'] ?? ''); ?>" maxlength="50" required>
                                    <input type="hidden" value="<?php echo e($company['id']); ?>" name="id">
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e($company['customer_id'] ?? ''); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e($company['email'] ?? ''); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e($company['phone'] ?? ''); ?>" maxlength="20" required>
...
unset($__errorArgs, $__bag); ?>" required><?php echo e($company['address'] ?? ''); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e($company['zipcode'] ?? ''); ?>" maxlength="10">
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($type['id']); ?>" <?php echo e(($company['company_type_id'] ?? '') == $type['id'] ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" required>
                                    <option value="1" <?php echo e(($company['is_pkp'] ?? '') == '1' ? 'selected' : ''); ?>>Ya</option>
                                    <option value="0" <?php echo e(($company['is_pkp'] ?? '') == '0' ? 'selected' : ''); ?>>Tidak</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e($company['npwp_number'] ?? ''); ?>" maxlength="25">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <?php if(!empty($company['npwp_file'])): ?>
                                    <small class="text-muted">File lama: <a href="<?php echo e(config('app.backend_url') . '/storage/' . $company['npwp_file']); ?>" target="_blank">Lihat</a></small>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6">
                                ...
                                <?php if(!empty($company['sppkp_file'])): ?>
                                    <small class="text-muted">File lama: <a href="<?php echo e(config('app.backend_url') . '/storage/' . $company['sppkp_file']); ?>" target="_blank">Lihat</a></small>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6">
                                ...
                                <?php if(!empty($company['skt_file'])): ?>
                                    <small class="text-muted">File lama: <a href="<?php echo e(config('app.backend_url') . '/storage/' . $company['skt_file']); ?>" target="_blank">Lihat</a></small>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="is_active" class="form-select">
                                    <option value="1" <?php echo e(($company['is_active'] ?? '') == '1' ? 'selected' : ''); ?>>Aktif</option>
                                    <option value="0" <?php echo e(($company['is_active'] ?? '') == '0' ? 'selected' : ''); ?>>Tidak Aktif</option>
                                </select>
                            </div>
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Edit Data Perusahaan'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Muhamad Sobirin\project\front-ias2\resources\views/pages/company/edit.blade.php ENDPATH**/ ?>