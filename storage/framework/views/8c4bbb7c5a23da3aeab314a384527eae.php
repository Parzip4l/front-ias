                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo e(route('posisi.store')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        function openEditModal(id, name, headId) {
            ...
            form.action = `<?php echo e(route('posisi.update')); ?>`;
...
<?php echo $__env->make('layouts.vertical', ['title' => 'Jabatan List Management'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Muhamad Sobirin\project\front-ias2\resources\views/pages/usermanagement/posisi/index.blade.php ENDPATH**/ ?>