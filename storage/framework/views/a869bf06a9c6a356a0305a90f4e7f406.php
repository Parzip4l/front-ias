...
<header class="app-topbar">
    <div class="page-container topbar-menu">
        <div class="d-flex align-items-center gap-2">
            ...
            <!-- Brand Logo -->
            <a href="<?php echo e(route('root')); ?>" class="logo">
                ...
                <div class="dropdown">
                    <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown" data-bs-offset="0,19" type="button" aria-haspopup="false" aria-expanded="false">
                        ...
                        <span class="d-lg-flex flex-column gap-1 d-none">
                            <h5 class="my-0"><?php echo e(session('user.name') ?? ''); ?></h5>
                            <h6 class="my-0 fw-normal"><?php echo e(session('user.role') ?? ''); ?></h6>
                        </span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item">
                            ...
                            <span class="align-middle">Wallet : <span class="fw-semibold">Rp.1.985.25</span></span>
                        </a>
...
<?php /**PATH /Users/muhamadsobirin/Documents/front-ias/resources/views/layouts/partials/topbar.blade.php ENDPATH**/ ?>